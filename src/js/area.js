	...
	var area =
		[
				...
				], type:1},
			{
				name:"北京",
				sub:[
					{name:"请选择",sub:[{name:"请选择"}]},
					{name:"北京",sub:[{name:"请选择"},{name:"东城区"},{name:"西城区"},{name:"崇文区"},{name:"宣武区"},{name:"朝阳区"},{name:"海淀区"},{name:"丰台区"},{name:"石景山区"},{name:"房山区"},{name:"通州区"},{name:"顺义区"},{name:"昌平区"},{name:"大兴区"},{name:"怀柔区"},{name:"平谷区"},{name:"门头沟区"},{name:"密云县"},{name:"延庆县"},{name:"其他"}]}
			...
			},
			{
				...
				sub:[{name:"请选择",sub:[{name:"请选择"}]},
					...
					{
						name:"东莞",
						sub:[{name:"请选择"},{name:"莞城区"},{name:"南城区"},{name:"东城区"},{name:"万江区"},{name:"石碣镇"},{name:"石龙镇"},{name:"茶山镇"},{name:"石排镇"},{name:"企石镇"},{name:"横沥镇"},{name:"桥头镇"},{name:"谢岗镇"},{name:"东坑镇"},{name:"常平镇"},{name:"寮步镇"},{name:"大朗镇"},{name:"麻涌镇"},{name:"中堂镇"},{name:"高埗镇"},{name:"樟木头镇"},{name:"大岭山镇"},{name:"望牛墩镇"},{name:"黄江镇"},{name:"洪梅镇"},{name:"清溪镇"},{name:"沙田镇"},{name:"道窖镇"},{name:"塘厦镇"},{name:"虎门镇"},{name:"厚街镇"},{name:"凤岗镇"},{name:"长安镇"}],
						type:0
					},
					{
						name:"中山",
						sub:[{name:"请选择"},{name:"中山"},{name:"其他"}],
						type:0
					},
					{
						name:"潮州",
			...
			},
			{
				...
				sub:[
					{name:"请选择",sub:[{name:"请选择"}]},
					{name:"上海",sub:[{name:"请选择"},{name:"黄浦区"},{name:"卢湾区"},{name:"徐汇区"},{name:"长宁区"},{name:"静安区"},{name:"普陀区"},{name:"闸北区"},{name:"虹口区"},{name:"杨浦区"},{name:"宝山区"},{name:"闵行区"},{name:"嘉定区"},{name:"松江区"},{name:"金山区"},{name:"青浦区"},{name:"南汇区"},{name:"奉贤区"},{name:"浦东新区"},{name:"崇明县"},{name:"其他"}]}
				],
				type:0
			},
			{
				...
				sub:[
					{name:"请选择",sub:[{name:"请选择"}]},
					{name:"天津",sub:[{name:"请选择"},{name:"和平区"},{name:"河东区"},{name:"河西区"},{name:"南开区"},{name:"河北区"},{name:"红桥区"},{name:"塘沽区"},{name:"汉沽区"},{name:"大港区"},{name:"东丽区"},{name:"西青区"},{name:"北辰区"},{name:"津南区"},{name:"武清区"},{name:"宝坻区"},{name:"静海县"},{name:"宁河县"},{name:"蓟县"},{name:"其他"}]}
				],
				type:0
			},
			{
			...
			},
			{
				...
				sub:[
					{name:"请选择",sub:[{name:"请选择"}]},
					{name:"香港",sub:[{name:"请选择"},{name:"中西区"},{name:"湾仔区"},{name:"东区"},{name:"南区"},{name:"深水埗区"},{name:"油尖旺区"},{name:"九龙城区"},{name:"黄大仙区"},{name:"观塘区"},{name:"北区"},{name:"大埔区"},{name:"沙田区"},{name:"西贡区"},{name:"元朗区"},{name:"屯门区"},{name:"荃湾区"},{name:"葵青区"},{name:"离岛区"},{name:"其他"}]}
				],
				type:0
			},
			{
				...
				sub:[
					{name:"请选择",sub:[{name:"请选择"}]},
					{name:"澳门",sub:[{name:"请选择"},{name:"花地玛堂区"},{name:"圣安多尼堂区"},{name:"大堂区"},{name:"望德堂区"},{name:"风顺堂区"},{name:"嘉模堂区"},{name:"圣方济各堂区"},{name:"路凼"},{name:"其他"}]}
				],
				type:0
			},
			{
				...
				sub:[
					{name:"请选择",sub:[{name:"请选择"}]},
					{name:"台湾",sub:[{name:"请选择"},{name:"台北市"},{name:"高雄市"},{name:"台北县"},{name:"桃园县"},{name:"新竹县"},{name:"苗栗县"},{name:"台中县"},{name:"彰化县"},{name:"南投县"},{name:"云林县"},{name:"嘉义县"},{name:"台南县"},{name:"高雄县"},{name:"屏东县"},{name:"宜兰县"},{name:"花莲县"},{name:"台东县"},{name:"澎湖县"},{name:"基隆市"},{name:"新竹市"},{name:"台中市"},{name:"嘉义市"},{name:"台南市"},{name:"其他"}]}
				],
				type:0
			},
			{

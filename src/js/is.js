/*
* @Author: fengyun2
* @Date:   2016-04-10 10:34:58
* @Last Modified by:   fengyun2
* @Last Modified time: 2016-04-10 12:11:45
*/
...
;(function (root, factory) {
    ...
    is.arguments = function(value) {    // fallback check is for IE
        return (!is.null(value)) && (toString.call(value) === '[object Arguments]' || (typeof value === 'object' && 'callee' in value));
    };
    ...
    is.equal = function(value1, value2) {
        ...
        if(is.number(value1, value2)) {
            return value1 === value2 && 1 / value1 === 1 / value2;
        }
        // check regexps as strings too
        if(is.string(value1, value2) || is.regexp(value1, value2)) {
            return '' + value1 === '' + value2;
        }
        if(is.boolean(value1, value2)) {
            return value1 === value2;
        }
        return false;
    };
    ...
    is.above = function(numb, min) {
        return is.number(numb, min) && numb > min;
    };

    // is a given number above maximum parameter?
    is.under = function(numb, max) {
        return is.number(numb, max) && numb < max;
    };

    // is a given number within minimum and maximum parameters?
    is.within = function(numb, min, max) {
        return is.number(numb, min, max) && numb > min && numb < max;
    };
    ...
    is.finite = isFinite || function(numb) {
        return numb !== Infinity && numb !== -Infinity && is.nan(numb);
    };
    ...
    is.capitalized = function(str) {
        ...
        return is.truthy.apply(null, capitalized);
    };
    ...
    is.inDateRange = function(obj, startObj, endObj) {
        if((!is.date(obj)) || (!is.date(startObj)) || (is.date(endObj))) {
            return false;
        }
